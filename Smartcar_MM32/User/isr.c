...
{
	extern void tim1_interrupt_handler (void);
...
{
	extern void tim8_interrupt_handler (void);
	tim8_interrupt_handler();
...
{
	extern void tim14_interrupt_handler (void);
	tim14_interrupt_handler();
