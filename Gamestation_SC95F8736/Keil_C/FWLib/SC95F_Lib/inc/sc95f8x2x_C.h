...
sbit	IPT2   = IP ^
               5;		//PWM中断优先控制位	0:设定 PWM的中断优先权是 “低”		1:设定 PWM 的中断优先权是 “高”
sbit 	IPUART = IP ^
               4;		//SIF中断优先控制位	0:设定 SIF的中断优先权是 “低”		1:设定 SIF的中断优先权是 “高”
sbit 	IPT1   = IP ^
               3;		//Timer1中断优先控制位	0:设定 Timer 1的中断优先权是 “低”	1:设定 Timer 1的中断优先权是 “高”
sbit	IPINT1 = IP ^
               2;		//32K Base Timer中断优先控制位		0:设定 32K的中断优先权是 “低”		1:设定 32K的中断优先权是 “高”
sbit 	IPT0   = IP ^
...
*SC95F8521封装未引出的管脚: P02/P03/P04/P06/P07
******************************************/
sbit 	P07 = P0 ^ 7;
sbit 	P06 = P0 ^ 6;
sbit 	P05	= P0 ^ 5;
...
/******************* P5 ******************
*SC95F8525封装未引出的管脚：无
*SC95F8523封装未引出的管脚：P52/P53/P54/P55
*SC95F8522封装未引出的管脚：P50/P51/P52/P53/P54/P55
*SC95F8521封装未引出的管脚：P50/P51/P52/P53/P54/P55
******************************************/
sbit 	P55	= P5 ^ 5;
sbit 	P54	= P5 ^ 4;
sbit 	P53	= P5 ^ 3;
